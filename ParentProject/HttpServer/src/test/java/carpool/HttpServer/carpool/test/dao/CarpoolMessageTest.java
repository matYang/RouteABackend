...
public class CarpoolMessageTest {
	...
	public void testMessageIsOpen() throws LocationNotFoundException{
		...
		message.setState(carpool.HttpServer.configurations.EnumConfig.MessageState.closed);
		message2.setState(carpool.HttpServer.configurations.EnumConfig.MessageState.deleted);
		message3.setState(carpool.HttpServer.configurations.EnumConfig.MessageState.open);
		message3.setDeparture_time(DateUtility.getCurTimeInstance());
		//This will pass
		message4.setState(carpool.HttpServer.configurations.EnumConfig.MessageState.open);
		message4.setDeparture_time(dt3);
		//Set Message states and Dt
		message5.setState(carpool.HttpServer.configurations.EnumConfig.MessageState.open);
		message5.setDeparture_time(dt2);
		message6.setState(carpool.HttpServer.configurations.EnumConfig.MessageState.deleted);
		message6.setDeparture_time(DateUtility.getCurTimeInstance());
		message7.setState(carpool.HttpServer.configurations.EnumConfig.MessageState.closed);
