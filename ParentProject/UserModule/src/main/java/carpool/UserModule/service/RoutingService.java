package carpool.UserModule.service;
...
import carpool.UserModule.resources.letterResource.LetterResourceId;
import carpool.UserModule.resources.letterResource.LetterUserResource;
import carpool.UserModule.resources.locationResource.*;
import carpool.UserModule.resources.notificationResource.*;
import carpool.UserModule.resources.transactionResource.*;
import carpool.UserModule.resources.userResource.*;
import carpool.UserModule.resources.userResource.userAuthResource.ChangePasswordResource;
import carpool.UserModule.resources.userResource.userAuthResource.ForgetPasswordResource;
import carpool.UserModule.resources.userResource.userAuthResource.LogInResource;
import carpool.UserModule.resources.userResource.userAuthResource.LogOutResource;
import carpool.UserModule.resources.userResource.userAuthResource.SessionRedirect;
import carpool.UserModule.resources.userResource.userEmailResource.ResendActivationEmailResource;
import carpool.UserModule.resources.userResource.userEmailResource.UserEmailActivationResource;
import carpool.UserModule.resources.userResource.userEmailResource.UserEmailResource;
